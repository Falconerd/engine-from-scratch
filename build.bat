...
set files=deps\src\glad.c src\main.c src\engine\global.c %render% %io% %config% %input% %time% %physics% %array_list% %entity% %animation% %audio%
set libs=.\deps\lib\SDL2main.lib .\deps\lib\SDL2.lib .\deps\lib\SDL2_mixer.lib

CL /Zi /I .\deps\include %files% /link %libs% /OUT:mygame.exe
